...
/*criação de tabela autor, contendo informações dos autores dos livros da biblioteca*/
...
/*criação da tabela localização, contendo informações sobre onde se encontram os livros*/
...
/*criação da tabela emprestimo, com datas de emprestimo e devolução, além das informações do livro pego e do cliente*/
